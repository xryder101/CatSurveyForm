...
$(function () {
    ...
    function validateForm() {
        ...
        var formValidation1 = document.forms["myForm3"]["haircolor"].value;
        var formValidation2 = document.forms["myForm3"]["shape"].value;
        var formValidation3 = document.forms["myForm3"]["length"].value;
        var formValidation4 = document.forms["myForm3"]["extrainfo"].value;
...
/*$(function(){$("form").submit(function(){validateForm();if(validateForm()==true){var validate=confirm("Are you sure you want to submit?");if(validate==true){alert("Form Submitted");}else{return false;}}else{return false;}});function validateForm(){var formValidation1=document.forms["myForm3"]["haircolor"].value;var formValidation2=document.forms["myForm3"]["shape"].value;var formValidation3=document.forms["myForm3"]["length"].value;var formValidation4=document.forms["myForm3"]["extrainfo"].value;if(formValidation1==""||formValidation2==""||formValidation3==""||formValidation4==""){alert("All fields must be filled before submission");return false;}else{return true;}}});*/